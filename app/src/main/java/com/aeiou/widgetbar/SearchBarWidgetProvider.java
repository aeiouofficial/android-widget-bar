...
public final class SearchBarWidgetProvider extends AppWidgetProvider {
    ...
    private static RemoteViews buildViews(Context context, int widgetId, boolean editing) {
        ...
        Intent composeIntent = new Intent(context, SearchActivity.class);
        ...
        views.setOnClickPendingIntent(R.id.provider_icon, composePending);
        views.setOnClickPendingIntent(R.id.search_hint, composePending);
